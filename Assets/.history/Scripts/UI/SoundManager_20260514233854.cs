...
public class SoundManager : MonoBehaviour
{
    ...
    public static void PlayFire()        => instance.audioSource.PlayOneShot(instance.fireSound);
    public static void PlayPoison()      => instance.audioSource.PlayOneShot(instance.poisonSound);
    public static void PlayHealing()     => instance.audioSource.PlayOneShot(instance.healingSound);
