...
namespace VocabLearning.UI
{
    ...
    public partial class VocabStudyController : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            // Tự động phát âm thanh click siêu nhạy cho MỌI nút bấm trong game
            _root.RegisterCallback<ClickEvent>(evt => 
            {
                ...
                while (el != null)
                {
                    if (el is Button)
                    {
                        // TRÁNH LỖI CHỒNG ÂM THANH: Nếu là nút chọn đáp án thì không phát tiếng click thường
                        // vì hàm OnBattleAnswer sẽ tự phát tiếng Correct/Wrong 
                        ...
                        break; // Đã tìm thấy nút, phát nhạc rồi thì thoát vòng lặp
                    }
                    el = el.parent; // Trèo dần lên cây giao diện để kiểm tra
                }
