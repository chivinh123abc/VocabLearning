...
namespace VocabLearning.UI
{
    public partial class VocabStudyController 
    {
        ...
        public void ShowSettingsPopup()
        {
            ...
            if (SettingScreenAsset != null)
            {
                if (_settingsOverlay == null || _settingsOverlay.parent == null)
                {
                    SettingScreenAsset.CloneTree(_root);
            ...
            Debug.LogWarning("SettingScreenAsset is not assigned in Inspector!");
        }
        ...
        private void BindSettingsEvents()
        {
            ...
            if (sldSfx != null)
            {
                sldSfx.value = SoundManager.GetVolume();
